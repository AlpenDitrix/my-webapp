...
public class HtmlBuilder {
    ...
    static {
       StringBuilder sb = new StringBuilder("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">");
        sb.append("<HTML><HEAD><TITLE>Dummy talkie web-appliaction</TITLE><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"></HEAD>");
        ...
        sb.append("<INPUT TYPE=\"TEXT\" NAME=\"quest\" onfocus=\"this.value=\'\'\" onblur=\"if (this.value==\'\') this.value=\'не программировать\'\" VALUE=\"не программировать\"><BR>");
